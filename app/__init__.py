...
# # ADD THESE LINES - Creates tables and users on Render
...
from .api.auth_routes import auth_routes
from .api.product_routes import product_routes
from .api.cart_routes import cart_routes   # 👈 NEW IMPORT
from .api.paypal_routes import paypal_routes
from .seeds import seed_commands
...
app.register_blueprint(auth_routes, url_prefix='/api/auth')
app.register_blueprint(product_routes, url_prefix='/api/products')
app.register_blueprint(cart_routes, url_prefix='/api/cart')   # 👈 NEW BLUEPRINT
